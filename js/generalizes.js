...
//	d3v0.json("source/json/ranges.json", function(json) {
...
//	var q = d3v0_queue.queue();
//	q.defer(d3v0.csv, "source/csv/rugbyMatch.csv", type).defer(d3v0.json,
...
//	var max = d3v0.max(dataProcessing1, function(aray){
...
//	var max = d3v0.max(dataProcessing2, function(aray){
//		return d3v0.max(aray.values,function(d){return d.y0+d.y;});
//	})
...
function calculeNumIntervals(brushObject, timePolarity, nTimeGranularity) {
	var result;
	switch (timePolarity) {
	case 0:result = d3v0.time.minutes(brushObject.extent()[0], brushObject.extent()[1], nTimeGranularity).length;
		break;
	case 1:result = d3v0.time.hours(brushObject.extent()[0],brushObject.extent()[1], nTimeGranularity).length;
		break;
	case 2:result = d3v0.time.days(brushObject.extent()[0], brushObject.extent()[1],nTimeGranularity).length;
		break;
	case 3:result = d3v0.time.weeks(brushObject.extent()[0],brushObject.extent()[1], nTimeGranularity).length;
		break;
	case 4:result = d3v0.time.months(brushObject.extent()[0],brushObject.extent()[1], nTimeGranularity).length;
		break;
	case 5:result = d3v0.time.years(brushObject.extent()[0],brushObject.extent()[1], nTimeGranularity).length;
		break;
	}
	return result;
}
...
function intervals(timePolarity, i){
	...
	switch (timePolarity) { 
		case 0:
			switch (i) { 
				case 0:
					interval = (d3v0.time.minutes(brushContextNorLeft.extent()[0],
							brushContextNorLeft.extent()[1])).length;
					break;
				case 1:
					interval = (d3v0.time.minutes(brushContextDisLeft.extent()[0],
							brushContextDisLeft.extent()[1])).length;
					break;
				case 2:
					interval = (d3v0.time.minutes(brushContext.extent()[0],
							brushContext.extent()[1])).length;
					break;
				case 3:
					interval = (d3v0.time.minutes(brushContextDisRight.extent()[0],
							brushContextDisRight.extent()[1])).length;
					break;
				case 4:
					interval = (d3v0.time.minutes(brushContextNorRight.extent()[0],
		...
		case 1:
			switch (i) { 
				case 0:
					interval = (d3v0.time.hours(brushContextNorLeft.extent()[0],
							brushContextNorLeft.extent()[1])).length;
					break;
				case 1:
					interval = (d3v0.time.hours(brushContextDisLeft.extent()[0],
							brushContextDisLeft.extent()[1])).length;
					break;
				case 2:
					interval = (d3v0.time.hours(brushContext.extent()[0],
							brushContext.extent()[1])).length;
					break;
				case 3:
					interval = (d3v0.time.hours(brushContextDisRight.extent()[0],
							brushContextDisRight.extent()[1])).length;
					break;
				case 4:
					interval = (d3v0.time.hours(brushContextNorRight.extent()[0],
							brushContextNorRight.extent()[1])).length;
					break;
			}
		break;			
		case 2:
			switch (i) { 
				case 0:
					interval = (d3v0.time.days(brushContextNorLeft.extent()[0],
							brushContextNorLeft.extent()[1])).length;
					break;
				case 1:
					interval = (d3v0.time.days(brushContextDisLeft.extent()[0],
							brushContextDisLeft.extent()[1])).length;
					break;
				case 2:
					interval = (d3v0.time.days(brushContext.extent()[0],
							brushContext.extent()[1])).length;
					break;
				case 3:
					interval = (d3v0.time.days(brushContextDisRight.extent()[0],
							brushContextDisRight.extent()[1])).length;
					break;
				case 4:
					interval = (d3v0.time.days(brushContextNorRight.extent()[0],
							brushContextNorRight.extent()[1])).length;
					break;
			}
		break;			
		case 3:
			switch (i) { 
				case 0:
					interval = (d3v0.time.weeks(brushContextNorLeft.extent()[0],
							brushContextNorLeft.extent()[1])).length;
					break;
				case 1:
					interval = (d3v0.time.weeks(brushContextDisLeft.extent()[0],
							brushContextDisLeft.extent()[1])).length;
					break;
				case 2:
					interval = (d3v0.time.weeks(brushContext.extent()[0],
							brushContext.extent()[1])).length;
					break;
				case 3:
					interval = (d3v0.time.weeks(brushContextDisRight.extent()[0],
							brushContextDisRight.extent()[1])).length;
					break;
				case 4:
					interval = (d3v0.time.weeks(brushContextNorRight.extent()[0],
							brushContextNorRight.extent()[1])).length;
					break;
			}
		break;			
		case 4:
			switch (i) { 
				case 0:
					interval = (d3v0.time.months(brushContextNorLeft.extent()[0],
							brushContextNorLeft.extent()[1])).length;
					break;
				case 1:
					interval = (d3v0.time.months(brushContextDisLeft.extent()[0],
							brushContextDisLeft.extent()[1])).length;
					break;
				case 2:
					interval = (d3v0.time.months(brushContext.extent()[0],
							brushContext.extent()[1])).length;
					break;
				case 3:
					interval = (d3v0.time.months(brushContextDisRight.extent()[0],
							brushContextDisRight.extent()[1])).length;
					break;
				case 4:
					interval = (d3v0.time.months(brushContextNorRight.extent()[0],
							brushContextNorRight.extent()[1])).length;
					break;
			}
		break;	
		case 5:
			switch (i) { 
				case 0:
					interval = (d3v0.time.years(brushContextNorLeft.extent()[0],
							brushContextNorLeft.extent()[1])).length;
					break;
				case 1:
					interval = (d3v0.time.years(brushContextDisLeft.extent()[0],
							brushContextDisLeft.extent()[1])).length;
					break;
				case 2:
					interval = (d3v0.time.years(brushContext.extent()[0],
							brushContext.extent()[1])).length;
					break;
				case 3:
					interval = (d3v0.time.years(brushContextDisRight.extent()[0],
							brushContextDisRight.extent()[1])).length;
					break;
				case 4:
					interval = (d3v0.time.years(brushContextNorRight.extent()[0],
							brushContextNorRight.extent()[1])).length;
					break;
			}
		break;				
...
function getTextWidth(text, font){
	d3v0.select("body").append("canvas").attr("id",'myCanvas')
	var c=document.getElementById('myCanvas');
	var ctx=c.getContext('2d');
	ctx.font=font;
	var m=ctx.measureText(text);
	d3v0.selectAll("#myCanvas").remove();
	return m.width;
}
...
//	// dateRange = d3v0.time.minutes(d3v0.time.minute.floor(dateMinRange),d3v0.time.minute.ceil(dateMaxRange),nTimeGranularity);
//	switch (timePolarity) {
//		case 0: dateRange = d3v0.time.minutes(d3v0.time.minute.floor(dateMinRange),d3v0.time.minute.ceil(dateMaxRange), nTimeGranularity);
//			break;
//		case 1: dateRange = d3v0.time.hours(d3v0.time.hour.floor(dateMinRange),d3v0.time.hour.ceil(dateMaxRange), nTimeGranularity);
//			break;
//		case 2: dateRange = d3v0.time.days(d3v0.time.day.floor(dateMinRange), d3v0.time.day.ceil(dateMaxRange), nTimeGranularity);
//			break;
//		case 3: dateRange = d3v0.time.weeks(d3v0.time.week.floor(dateMinRange),d3v0.time.week.ceil(dateMaxRange), nTimeGranularity);
//			break;
//		case 4: dateRange = d3v0.time.months(d3v0.time.month.floor(dateMinRange),d3v0.time.month.ceil(dateMaxRange), nTimeGranularity);
//			break;
//		case 5: dateRange = d3v0.time.years(d3v0.time.year.floor(dateMinRange),d3v0.time.year.ceil(dateMaxRange), nTimeGranularity);
//			break;
//	}
//
...
////						.call(xAxisContext);
//
////	d3v0.select("#nTimeGranularity-text").text(nTimeGranularity);
////	d3v0.select("#nTimeGranularity-value").property("value", nTimeGranularity);
//
